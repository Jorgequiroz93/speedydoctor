...
var map = {
	"./calls_channel.js": "./app/javascript/channels/calls_channel.js",
	"./reporting_channel.js": "./app/javascript/channels/reporting_channel.js"
};
...
/***/ "./app/javascript/channels/calls_channel.js":
/*!**************************************************!*\
  !*** ./app/javascript/channels/calls_channel.js ***!
  \**************************************************/
/*! no exports provided */
...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("CallsChannel", {
  received: function received(data) {
    ...
    if (data.doctor_id === current_user_id) {
      ...
      if (confirm("Incoming call. Taking you to the consultation!") === true) {
        ...
        location.href = "".concat(url.origin, "/consultations/").concat(data.consultation_id);
      }
    }
  }
});
...
/***/ "./app/javascript/channels/reporting_channel.js":
/*!******************************************************!*\
  !*** ./app/javascript/channels/reporting_channel.js ***!
  \******************************************************/
/*! no exports provided */
...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("ReportingChannel", {
  received: function received(data) {
    console.log("data: " + data);
    console.log("current_user_id: " + current_user_id);
...
var map = {
	"./fetch_time_controller.js": "./app/javascript/controllers/fetch_time_controller.js",
	"./hello_controller.js": "./app/javascript/controllers/hello_controller.js",
	"./save_doc_fields_controller.js": "./app/javascript/controllers/save_doc_fields_controller.js",
	"./save_fields_controller.js": "./app/javascript/controllers/save_fields_controller.js"
};
...
/***/ "./app/javascript/controllers/fetch_time_controller.js":
/*!*************************************************************!*\
  !*** ./app/javascript/controllers/fetch_time_controller.js ***!
  \*************************************************************/
/*! exports provided: default */
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function connect() {
      ...
      }).on('participant-joined', function (event) {
        console.log('Participants: ' + ++participants);
        if (participants === 2 && !isTimerRunning) startTimer();
      }).on('left-meeting', function (event) {
        console.log('Participants: ' + --participants);
        if (participants != 2 && isTimerRunning) stopTimer();
      }).on('participant-left', function (event) {
        console.log('Participants: ' + --participants);
        if (participants != 2 && isTimerRunning) stopTimer();
      ...
      function startTimer() {
        ...
        myInterval = setInterval(function () {
          ...
          myThis.timerTarget.textContent = "".concat(Math.round(seconds / 60).toString().padStart(2, '0'), ":").concat(Math.round(seconds % 60).toString().padStart(2, '0'));
      ...
      function stopTimer() {
        ...
        console.log('totalPrice is ', totalPrice, 'json: ', JSON.stringify({
          'status': 'finished',
          'end_time': end,
        ...
        document.getElementById('bill').innerText = "".concat(Math.round((end - start) / 10 * 2.5 / 60) / 100, " $");
...
/***/ "./app/javascript/controllers/save_doc_fields_controller.js":
/*!******************************************************************!*\
  !*** ./app/javascript/controllers/save_doc_fields_controller.js ***!
  \******************************************************************/
/*! exports provided: default */
...
_default.targets = ["doctorNotes", "advice", "prescription"];


/***/ }),

/***/ "./app/javascript/controllers/save_fields_controller.js":
/*!**************************************************************!*\
  !*** ./app/javascript/controllers/save_fields_controller.js ***!
  \**************************************************************/
/*! exports provided: default */
  ...
  _createClass(_default, [{
    ...
    value: function save() {
      ...
      fetch(window.location.href, {
        ...
        body: JSON.stringify({
          'patient_notes': this.patientNotesTarget.value
        })
...
/******/ });
//# sourceMappingURL=application-74a5bc9ee6c81ac0ed4e.js.map